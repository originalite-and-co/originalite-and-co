...
import {CatalogNavButton, CatalogNavLink} from "../CatalogNav/LinkButtonGenerators";
...
function MainCategoryLink({category, isDesktop, onHover, onClick, isDropdownActive}) {
    return (
