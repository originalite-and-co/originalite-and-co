...
function Search(props) {
  ...
  />, []);
                    ...
                    return (
                        <form onSubmit={handleSubmit} className={classes.form}>
                            ...
                            <Box className={`${classes.textFieldWrapper} wrapper`}>
                                ...
                                {errors.search && touched.search && <p className={classes.error}>{errors.search}</p>}
                            </Box>
    ...
    return (
        <>
            <Box onClick={handleIconClick} className={classes.imageWrapper} data-testid='nav-item-search'>
